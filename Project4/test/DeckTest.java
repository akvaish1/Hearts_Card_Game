...
public class DeckTest {
    ...
    public void testNextCardB() {
        // TODO: Add another test for nextCard
        // 1. call the nextCard() method multiple times
        // 2. then test that the next nextCard() call returns the correct Card             deck.nextCard();
    ...
    public void testGetNextB() {
        // TODO: Write another test for getNext()
        // 1. call the nextCard() method a few times
        // 2. then test that getNext() returns the correct value
        fail("No test added");        
    }    
    ...
    public void testEqualsB() {
        // TODO: Add test for Decks with equal cards arrays but different next values
        // 1. create a new Deck
        // 2. call the nextCard method on the new Deck
        // 3. test that equals method comaring deck and the new Deck returns false
        fail("No test added");        
    }

    @Test
    public void testEqualsC() {
        // TODO: Add test for Decks with next equal but unequal cards arrays
        // 1. create a new Deck
